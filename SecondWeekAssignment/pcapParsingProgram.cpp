...
//void displayPacketHeaderInHexaDecimal(packetHeader pobj);
//void displayPacketHeader(packetHeader pobj);
//void displayEthernetHeaderInHexaDecimal(ethernetHeader eobj);
//void displayEthernetHeader(ethernetHeader eobj);
//void displayIPV4HeaderInHexaDecimal(ipv4Header i4obj);
//void displayIPV4Header(ipv4Header i4obj);
//void displayTcpHeaderInHexaDecimal(tcpHeader tcpHobj);
//void displayTcpHeader(tcpHeader tcpHobj);
//void displayUdpHeaderInHexaDecimal(udpHeader udpHobj);
//void displayUdpHeader(udpHeader udpHobj);
