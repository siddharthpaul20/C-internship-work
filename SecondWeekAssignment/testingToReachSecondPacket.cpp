...
int main()
{
   ...
   cout<< "Ethernet header of packet ethernetType in int : " << eobj.ethernetType << endl;

   // now going to second packet
   printf("\nSecond packet ethernet header.\n");
   cout<<displayInHex(ntohl(pobj.captureLength))<<"\n";
   unsigned int tempPacketLength = hexadecimalToDecimal(displayInHex(pobj.captureLength));
   cout<<"\n"<<tempPacketLength<<"\n";
   inFile.seekg(40+tempPacketLength+16,ios::beg);
   inFile.read((char*) &eobj.destinationMAC,6);
   //inFile.seekg(46,ios::beg);
   inFile.read((char*) &eobj.sourceMAC,6);
   //inFile.seekg(52,ios::beg);
   ...
   cout<< "1Ethernet header of packet destinationMAC : 0x" << displayInHex(eobj.destinationMAC) << endl;
   cout<< "Ethernet header of packet sourceMAC : 0x" << displayInHex(eobj.sourceMAC) << endl;
   cout<< "Ethernet header of packet ethernetType : 0x" << displayInHex(eobj.ethernetType) << endl;
   cout<< "1 Ethernet header of packet ethernetType in int : " << eobj.ethernetType << endl;
